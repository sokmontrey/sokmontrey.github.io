...
Same as before, power rule $\frac{d}{dx}x^2 = 2x$
</Hover>
...
Derivative of $x^2$ with respect to $y$ is $0$. (Power rule, x is a constant $\times y^0$)
</Hover>
...
- Derivative of $\sin(\mathrm{inner\;function})$ is $\cos(\mathrm{inner\;function})$. (Trig rule) 
- Multiply with the derivative of the inner function with respect to y. (Chain rule)
...
Derivative of $x + y^2$ with respect to $y$ is $2y$. (Power rule, $x$ is a constant $\times y^2$)
</Hover>
