...
The most important thing for auto diff is idea of **Chain Rule**. Any function that can be represented as a computational graph can be differentiated using the chain rule. We don't even need the other combinational rules. 
