...
By the way, this is a graph, a computational graph. It is consisted of connected nodes representing an operation. The arrows or edges represent how the output from one operation will be used in another.
