...
1. You want to know how is a function $f(x)$ changing at a specific input $a$.
...
Bolow is the **fundamental definition of derivative**. 
...
5. But we, sane individuals, would not want to use it in that form. The formula can be used to find derivative of any <Hover> 
    <span slot="toggler"> elementary functions </span>
    <ul> <li>$x^n$</li> <li>$e^x$</li> <li>$\sin$</li> <li>$\ln$</li> <li>...</li> </ul> 
</Hover>, creating elementary rules. These rules then can be used to solve any advanced function using <Hover>
...
<span slot="toggler"> $\frac{d}{dx}f = 2x$</span> <br/>
