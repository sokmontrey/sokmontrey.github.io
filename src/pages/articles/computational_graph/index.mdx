...
<AbstractFunction client:only="svelte" />

This is very abstract definition of a function. A more familiar form of a function are the one takes in a number and gives out, potentially, a different number.
...
```
The Above function illustration
```
